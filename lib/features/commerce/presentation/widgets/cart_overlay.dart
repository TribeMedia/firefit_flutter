...
class CartOverlay extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final orderController = ref.watch(
      orderControllerProvider(globalProviderId),
    );
                                              ...
                                              if (item.imageUrl != null)
                                                ClipRRect(
                                                  ...
                                                  child: SizedBox(
                                                    width: 120,
                                                    height:
                                                        67.5, // 16:9 aspect ratio (120 * 9/16)
    ...
    return Row(
      children: [
        ...
        Padding(
          ...
          child: Text(value.toString(), style: theme.textTheme.titleMedium),
        ),
        ShadButton(
