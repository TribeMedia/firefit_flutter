...
class Fragment$DeliveryLocation {
  ...
  factory Fragment$DeliveryLocation.fromJson(Map<String, dynamic> json) {
    ...
    return Fragment$DeliveryLocation(
      ...
      startOpenTime: DateTime.parse((l$startOpenTime as String)),
      endOpenTime: DateTime.parse((l$endOpenTime as String)),
  ...
  final DateTime startOpenTime;

  final DateTime endOpenTime;
  ...
  Map<String, dynamic> toJson() {
    ...
    _resultData['startOpenTime'] = l$startOpenTime.toIso8601String();
    final l$endOpenTime = endOpenTime;
    _resultData['endOpenTime'] = l$endOpenTime.toIso8601String();
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Fragment$DeliveryLocation(
        ...
        startOpenTime: startOpenTime == _undefined || startOpenTime == null
            ? _instance.startOpenTime
            : (startOpenTime as DateTime),
        endOpenTime: endOpenTime == _undefined || endOpenTime == null
            ? _instance.endOpenTime
            : (endOpenTime as DateTime),
...
extension ClientExtension$Query$ValidDeliveryLocations
  ...
  Future<graphql.QueryResult<Query$ValidDeliveryLocations>>
      query$ValidDeliveryLocations(
          ...
          await this.query(options ?? Options$Query$ValidDeliveryLocations());
  graphql.ObservableQuery<
      Query$ValidDeliveryLocations> watchQuery$ValidDeliveryLocations(
          [WatchOptions$Query$ValidDeliveryLocations? options]) =>
      this.watchQuery(options ?? WatchOptions$Query$ValidDeliveryLocations());
...
graphql_flutter.QueryHookResult<Query$ValidDeliveryLocations>
    useQuery$ValidDeliveryLocations(
        ...
        graphql_flutter
            .useQuery(options ?? Options$Query$ValidDeliveryLocations());
graphql.ObservableQuery<Query$ValidDeliveryLocations>
    useWatchQuery$ValidDeliveryLocations(
            [WatchOptions$Query$ValidDeliveryLocations? options]) =>
        graphql_flutter.useWatchQuery(
            options ?? WatchOptions$Query$ValidDeliveryLocations());
...
class Query$ValidDeliveryLocations$Widget
  ...
  Query$ValidDeliveryLocations$Widget({
    ...
    required graphql_flutter.QueryBuilder<Query$ValidDeliveryLocations> builder,
          ...
          key: key,
          options: options ?? Options$Query$ValidDeliveryLocations(),
          builder: builder,
        );
}
